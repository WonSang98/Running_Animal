...
public class TrapForest : MonoBehaviour
{
    ...
    public int num_pattern = 254; // ÆĞÅÏÀÇ ¼ö.
    ...
    public void TrapUpdate()
    {
        ...
        if (GameManager.Play.DS.timer <= 0)
        {
            ...
            else
            {
                ...
                if (GameManager.Play.DC.patternCnt == (num_pattern + 1)) // ¸ğµç ÇÔÁ¤ÀÌ 1È¸¾¿ ´Ù ³ª¿ÔÀ» °æ¿ì.
                {
    ...
    //trap_num ¼ø¼­ÀÇ ÇÔÁ¤À» pos¿¡ »ı¼ºÇÑ´Ù.
